...
export const priceListData = [
  {
    ...
    price: "600.000",
    features: [
      "1.500 trang in đen trắng.",
      "Phụ trội 120 đồng/ 1 trang",
      "Máy mới 95 - 99%",
      "Khổ in A3",
      "Tốc độ 65 trang/ phút",
      "In từ Laptop, PC, Điện thoại",
      "Miễn phí chức năng Scan",
      "Miễn phí lắp đặt, vật chuyển",
      "Hỗ trợ 24/7, tận nơi 20-30p",
    ],
  },
  {
    title: "GÓI ƯA THÍCH",
  ...
  },
  {
    ...
    price: "1.200.000",
    features: [
      "5.000 trang in đen trắng.",
      "Phụ trội 100 đồng/ 1 trang",
      "Máy mới 95 - 99%",
      "Khổ in A3",
      "Tốc độ 65 trang/ phút",
      "In từ Laptop, PC, Điện thoại",
...
export const questionList = [
  ...
  },
  {
    ...
    content:
      "Máy photocopy đa dạng về chúng loại, kích cỡ cũng như công suất làm việc. Chất lượng máy cho thuê đạt 90 – 95% so với máy mới.",
  },
  {
    icon: <SpeedIcon />,
